...
const features = [
  { icon: Tag, label: '70% Discounts' },
  { icon: Bell, label: 'Real-time offers' },
...
export const RegistrationLeftPanel = ({ accountType }: RegistrationLeftPanelProps) => {
  return (
    ...
    >
      ...
      {/* Single centered block: logo + tagline + features */}
      <div className='flex-1 flex flex-col justify-center px-14 py-16 relative z-10'>
        <div className='flex flex-col gap-10 '>
          {/* Logo sits directly above the heading — one visual unit */}
