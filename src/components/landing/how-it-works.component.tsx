...
const HowItWorks = () => {
  ...
  return (
    <section className='py-10 font-playfair'>
      <h2 className='text-3xl text-center font-bold'>{t(StringKey.HOW_IT_WORKS)}</h2>
      <h4 className='text-muted-foreground font-lg text-center mb-8'>
        {t(StringKey.SUSTAINABLE_EATING)}
      </h4>

      <div className='flex flex-col gap-6 md:flex-row md:gap-10'>
        <div className='border-4 rounded-[1.25rem] bg-white text-center p-10 border-brand-green-muted'>
          <div className='w-24 h-24 bg-brand-status-success-bg rounded-full mx-auto mb-4 flex items-center justify-center'>
        ...
        <div className='border-4 rounded-[1.25rem] bg-white text-center p-10 border-brand-green-muted'>
          <div className='w-24 h-24 bg-brand-orange-light rounded-full mx-auto mb-4 flex items-center justify-center'>
        ...
        <div className='border-4 rounded-[1.25rem] bg-white text-center p-10 border-brand-green-muted'>
          <div className='w-24 h-24 bg-brand-cream rounded-full mx-auto mb-4 flex items-center justify-center'>
